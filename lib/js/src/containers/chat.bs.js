...
function make(preferences, credentials, conversation, getLastMessage, closeWebchat, _) {
  var sendMessage = function (attachment) {
    if (conversation !== undefined) {
      Messages$ReactTemplate.Api[/* send */1](credentials, conversation[/* chatId */2], attachment);
      return /* () */0;
    } else {
      return /* () */0;
    }
  ...
  return /* record */[
          ...
          /* render */(function (self) {
              return React.createElement("div", {
                          className: chat
                        }, ReasonReact.element(undefined, undefined, Header$ReactTemplate.make(closeWebchat, preferences, /* array */[])), ReasonReact.element(undefined, undefined, Feed$ReactTemplate.make(preferences, self[/* state */1][/* messages */0], sendMessage, /* array */[])), ReasonReact.element(undefined, undefined, Input$ReactTemplate.make(sendMessage, undefined, undefined, /* array */[])));
            }),
                                  ...
                                  Messages$ReactTemplate.Api[/* poll */0](credentials, id, state[/* lastMessageId */2]).then((function (messagesOpt) {
                                          ...
                                          if (messagesOpt !== undefined) {
                                            ...
                                            if (messages.length) {
                                              ...
                                              waitTime = Caml_int32.imul(match[0], 1000);
                                            } else {
                                              waitTime = 3000;
                                            }
                                          } else {
