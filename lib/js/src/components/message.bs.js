...
function make(message$1, preferences, _) {
  return /* record */[
          ...
          /* render */(function () {
              ...
              switch (match.tag | 0) {
                ...
                case 3 : 
                    ...
                    break;
                case 4 : 
                    tmp = ReasonReact.element(undefined, undefined, Buttons$ReactTemplate.make(match[0], style, /* array */[]));
                    break;
                case 5 : 
                    tmp = ReasonReact.element(undefined, undefined, Carousel$ReactTemplate.make(match[0], /* array */[]));
                    break;
                default:
                  tmp = null;
              }
