...
function make(buttons$1, style, sendMessage, _) {
          ...
          /* render */(function () {
              ...
              return React.createElement("div", {
                          className: buttons
                            ...
                            }, Utils$ReactTemplate.truncate(buttons$1[/* bTitle */0], 640)), React.createElement("div", {
                              className: buttonsContainer
                            }, $$Array.mapi(renderButton, buttons$1[/* buttons */1].slice(0, 3))));
            }),
