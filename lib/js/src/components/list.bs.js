      ...
      /* :: */[
        ...
        /* :: */[
          ...
          /* :: */[
            ...
            /* :: */[
              Css.borderRight(Css.px(1), Css.solid, Css.lightgrey),
              /* [] */0
            ]
          ]
        ]
...
var list_ = Css.style(/* :: */[
      ...
      /* :: */[
        ...
        /* :: */[
          Css.selector(" .RecastAppListElement + .RecastAppListElement ", /* :: */[
...
function make(list_$1, sendMessage, _) {
  ...
  var renderElementSubtitle = function (subtitleOpt) {
    return Js_option.getWithDefault(null, Js_option.map((function (subtitle) {
                      return React.createElement("p", {
                                ...
                                }, Utils$ReactTemplate.truncate(subtitle, 50));
                    }), subtitleOpt));
  };
      ...
      switch (match$1[/* type_ */2]) {
        case "postback" : 
            return React.createElement("div", {
                      ...
                      }, Utils$ReactTemplate.truncate(title, 20));
        case "web_url" : 
  ...
  var renderElement = function (index, card) {
    return React.createElement("div", {
                key: String(index),
                className: "RecastAppListElement " + element
              }, renderElementImage(card[/* imageUrl */2]), React.createElement("div", {
                    className: elementContainer
                  }, React.createElement("p", {
                        className: elementTitle
                      }, Utils$ReactTemplate.truncate(card[/* title */0], 25)), renderElementSubtitle(card[/* subtitle */1]), renderElementButton(card[/* buttons */3])));
  };
  return /* record */[
          ...
          /* render */(function () {
              ...
              return React.createElement("div", {
                          className: list_
                              ...
                              }, ReasonReact.element(undefined, undefined, Button$ReactTemplate.make(Caml_array.caml_array_get(list_$1[/* buttons */1], 0), sendMessage, /* array */[]))));
            }),
